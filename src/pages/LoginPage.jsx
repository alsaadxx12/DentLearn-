            ...
            <div className="login-form">
                {!showAdminLogin ? (
                    <>
                        ...
                        <button type="button" className="btn-google" onClick={handleUserLogin}>
                    ...
                    <>
                        <h2 className="login-form-title">{t('adminLogin')}</h2>
                        <p className="login-form-subtitle">{t('adminLoginSubtitle')}</p>
